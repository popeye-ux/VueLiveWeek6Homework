<template>
  ...
  <product-modal ref="productModal" :temp-product="tempProduct" :is-new="isNew" @get-data="getData"></product-modal>
  <!-- 刪除產品 modal 開始 -->
  <del-product-modal ref="delProductModal" :temp-product="tempProduct" @update="getData"></del-product-modal>
  <!-- 刪除產品 modal 結束 -->
</template>
